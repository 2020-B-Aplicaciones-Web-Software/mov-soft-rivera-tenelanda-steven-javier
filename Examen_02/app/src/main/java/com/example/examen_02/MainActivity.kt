...
import com.example.examen_02.dto.FirestoreUsuarioDto
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val botonMostrarRecetasMedicas = findViewById<Button>(R.id.btn_mostrar_recetas)
        botonMostrarRecetasMedicas.setOnClickListener {
            val intent = Intent(
                this,
                MostrarRecetaMedica::class.java
            )
